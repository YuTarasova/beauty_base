...
Статус (status) - английские буквы и пробел, длиной до 32 символов. Стандартные статусы { "absent client", "completed", "unpaid", "absent staff", "interrupted", "cancelled" }.
...
* Изменение квалификаций сотрудников данного филиала (staff_type).
* Изменение расписания сотрудников данного филиала.
* Просмотр проблематичных записей, то есть записей со статусом отличающимся от "completed".

### Бухгалтер
* Просмотр количества отработанных часов каждого сотрудника в течение выбранного периода.
* Просмотр принесённой прибыли каждым сотрудником в течение выбранного периода.
